...
if ( isset($_POST['proceed']) && isset($_POST['senderacc']) ) {
    header("Location: detail.php?senderacc=".$_POST['senderacc']."&senderbalance=".$_POST['balance']);
    return;
}
    ...
    <div class="container my-5">
        <table class="table table-striped table-hover">
            ...
            foreach ( $rows as $row ) {
                ...
                echo('name="senderacc" value="'.$row['acc_no'].'">'."\n");
